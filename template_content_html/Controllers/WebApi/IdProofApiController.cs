...
{
    public class IdProofApiController : ApiController
    {
        public ICustomerService _CustomerService { get; set; }

        public IdProofApiController(ICustomerService CustomerService)
        {
        ...
        public void DeleteImage(string filePath)
        {
            try
            {
                ...
                var subPath = HttpContext.Current.Server.MapPath("~/IdProof");
